    ...
    <div class="about-me container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 pt-4 pt-lg-0 content" data-aos="fade-left">
                <h3>UI/UX / Social Media Managing / Web Developer / Video Editing</h3>
                <p class="fst-italic">
                ...
                <div class="row">
                    <div class="col-lg-6">
                        <ul>
                            <li><i class="bi bi-chevron-right"></i> <strong>Birthday:</strong> <span>April 10,
                                    2000</span></li>
                            {{-- <li><i class="bi bi-chevron-right"></i> <strong>Website:</strong>
                                <span>www.example.com</span>
                            </li> --}}
                            <li><i class="bi bi-chevron-right"></i> <strong>Phone:</strong> <span>+639455295031</span>
                            </li>
                            <li><i class="bi bi-chevron-right"></i> <strong>City:</strong> <span>Pangasinan,
                                    Philippines</span></li>
                        </ul>
                    </div>
                    <div class="col-lg-6">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-6 mt-5 mt-lg-0">
                <div class="count-box">
                    ...
                    <span data-purecounter-start="0" data-purecounter-end="540" data-purecounter-duration="1"
                        class="purecounter"></span>
    ...
    <div class="skills container">
        ...
        <div class="row skills-content">
            ...
            <div class="col-lg-6">
                ...
                <div class="progress">
                    <span class="skill">UI / UX <i class="val">100%</i></span>
                ...
                <div class="progress">
                    <span class="skill">Social Media Managing <i class="val">90%</i></span>
                    <div class="progress-bar-wrap">
            ...
            <div class="col-lg-6">
                <div class="progress">
                    <span class="skill">Web Developing <i class="val">100%</i></span>
                    <div class="progress-bar-wrap">
                        <div class="progress-bar" role="progressbar" aria-valuenow="100" aria-valuemin="0"
                            aria-valuemax="100"></div>
                    </div>
